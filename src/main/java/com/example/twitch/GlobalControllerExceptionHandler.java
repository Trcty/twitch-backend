...
import com.example.twitch.model.TwitchErrorResponse;
...
@ControllerAdvice // when each api/method in  controller runs, check if there is any error
public class GlobalControllerExceptionHandler {

    Logger logger = LoggerFactory.getLogger(GlobalControllerExceptionHandler.class);

    @ExceptionHandler(Exception.class) // default/general  handling
    ...
    @ExceptionHandler(ResponseStatusException.class)// specific handling
